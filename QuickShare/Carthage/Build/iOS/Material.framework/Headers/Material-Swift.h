...
*/
@property (nonatomic, readonly, strong) CapturePreview * _Null_unspecified preview;
/**
...
*/
@property (nonatomic, readonly, strong) NSMutableAttributedString * _Null_unspecified storage;
/**
